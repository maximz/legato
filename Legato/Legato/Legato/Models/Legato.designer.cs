...
namespace Legato.Models
{
    ...
    partial void OnModResponseChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FlagID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int FlagID
		{
			get
			{
	...
	public partial class Instrument : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _DisplayedStreetAddress;
    ...
    partial void OnHTMLChanging(string value);
    partial void OnHTMLChanged();
    partial void OnDisplayedStreetAddressChanging(string value);
    ...
    partial void OnAddressPrivacyChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DisplayedStreetAddress", DbType="NVarChar(MAX)")]
		public string DisplayedStreetAddress
		{
			get
			{
				return this._DisplayedStreetAddress;
			}
			set
			{
				if ((this._DisplayedStreetAddress != value))
				{
					this.OnDisplayedStreetAddressChanging(value);
					this.SendPropertyChanging();
					this._DisplayedStreetAddress = value;
					this.SendPropertyChanged("DisplayedStreetAddress");
					this.OnDisplayedStreetAddressChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AddressPrivacy", DbType="Int NOT NULL")]
		public int AddressPrivacy
		{
			get
			{
				return this._AddressPrivacy;
			}
			set
			{
				if ((this._AddressPrivacy != value))
				{
					this.OnAddressPrivacyChanging(value);
					this.SendPropertyChanging();
