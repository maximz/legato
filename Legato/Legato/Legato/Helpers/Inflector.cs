...
namespace Legato.Helpers
{
    public static class Inflector
    {
        ...
        /// <summary>
        /// Pluralizes the given word if count is equal to one. For example, if word is apple and count is one, we return apple; if word is apple and count is two, we return apples.
        /// </summary>
        /// <param name="word">The word.</param>
        /// <param name="count">The count.</param>
        /// <returns></returns>
        public static string AddSuffix(string word, int count)
        {
