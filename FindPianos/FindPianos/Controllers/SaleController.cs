...
{
    [HandleError]
    public class SaleController : CustomControllerBase
    {
        ...
        [Url("Sales/Review/View/{reviewId}")]
        ...
        [Url("Search/Sales")][CustomCache(NoCachingForAuthenticatedUsers=true,Duration = 7200, VaryByParam = "None")]
        public ActionResult List()
        {
            return View();
        }
        [Url("Sales/EnumerateBox")]
        ...
        [Url("Sales/Edit/Review/{reviewId}")]
        [HttpGet]
        [CustomAuthorization(AuthorizeSuspended = false, AuthorizeEmailNotConfirmed=false)]
