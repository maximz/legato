...
namespace FindPianos.Controllers
{
    ...
    public class JobsController : CustomControllerBase
    {
        ...
        [Url("Search/Jobs")][CustomCache(NoCachingForAuthenticatedUsers=true,Duration = 7200, VaryByParam = "None")]
        public ActionResult List()
        {
            return View();
        }
        [Url("Jobs/EnumerateBox")]
