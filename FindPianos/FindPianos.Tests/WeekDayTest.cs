...
namespace FindPianos.Tests
{
    ...
    /// <summary>
    ///This is a test class for WeekDayTest and is intended
    ///to contain all WeekDayTest Unit Tests
    ///</summary>
    [TestClass()]
    public class WeekDayTest
    {
        ...
        /// <summary>
        ///A test for WeekDay Constructor
        ///</summary>
        ...
        public void WeekDayConstructorTest()
        {
            WeekDay target = new WeekDay();
        ...
        {
            WeekDay_Accessor target = new WeekDay_Accessor(); // TODO: Initialize to an appropriate value
        ...
        {
            WeekDay target = new WeekDay(); // TODO: Initialize to an appropriate value
        ...
        [AspNetDevelopmentServerHost("C:\\Users\\Ilya\\Documents\\My Dropbox\\Summer Projects\\Repos\\findpianos\\FindPianos\\FindPianos", "/")]
        [UrlToTest("http://localhost:2574/")]
        public void WeekDayIDTest()
        {
            WeekDay target = new WeekDay(); // TODO: Initialize to an appropriate value
            int expected = 0; // TODO: Initialize to an appropriate value
            int actual;
            target.WeekDayID = expected;
            actual = target.WeekDayID;
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }

        /// <summary>
        ///A test for WeekDayName
        ///</summary>
        // TODO: Ensure that the UrlToTest attribute specifies a URL to an ASP.NET page (for example,
        // http://.../Default.aspx). This is necessary for the unit test to be executed on the web server,
        // whether you are testing a page, web service, or a WCF service.
        ...
        [AspNetDevelopmentServerHost("C:\\Users\\Ilya\\Documents\\My Dropbox\\Summer Projects\\Repos\\findpianos\\FindPianos\\FindPianos", "/")]
        [UrlToTest("http://localhost:2574/")]
        public void WeekDayNameTest()
        {
            WeekDay target = new WeekDay(); // TODO: Initialize to an appropriate value
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            target.WeekDayName = expected;
            actual = target.WeekDayName;
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
    }
